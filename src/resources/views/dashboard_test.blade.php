...
<head>
    ...
    @vite([
        'resources/plugins/morris/morris.css', //Morris Chart CSS
...
<body>
    ...
    @vite([
        ...
        'resources/js/plugins/morris/morris.min.js', // Morris Chart JS
        'resources/js/plugins/raphael/raphael.min.js', // Morris Chart JS
    ])
